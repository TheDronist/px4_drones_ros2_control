...
class VOXL_Offboard(Node):
    def __init__(self):
        ...
        self.declare_parameter('waypoint_z', 1.0)
        ...
        self.waypoint_x = self.get_parameter('waypoint_x').get_parameter_value().double_value
        self.waypoint_y = self.get_parameter('waypoint_y').get_parameter_value().double_value
        self.waypoint_z = self.get_parameter('waypoint_z').get_parameter_value().double_value
        self.waypoint_yaw = self.get_parameter('waypoint_yaw').get_parameter_value().double_value
    ...
    def timer_callback(self):
        ...
        if self.loiter == True:
            pos_x, pos_y, pos_z, yaw = self.waypoint_x, self.waypoint_y, self.waypoint_z, self.waypoint_yaw
